...
const $$Index = createComponent(($$result, $$props, $$slots) => {
  ...
  ], "data-astro-cid-r7cejkkl": true })} ${renderComponent($$result2, "FaqSection", $$FaqSection, { "phone": "55 4786 8402", "whatsapp": "5547868402", "schedule": "Lun\u2013Dom 8:00\u201320:00", "waMessage": "Hola, quiero cotizar mesas picnic para mi evento.", "items": [
    {
  ...
  ], "data-astro-cid-r7cejkkl": true })} </section>  ${renderComponent($$result2, "CtaBarFinal", $$CtaBarFinal, { "headline": "\xBFYa sabes qu\xE9 modelo necesitas?", "subtext": "Cotiza por WhatsApp o en l\xEDnea. Te respondemos con disponibilidad y precio el mismo d\xEDa.", "phone": "55 4786 8402", "whatsapp": "5547868402", "waMessage": "Hola, quiero cotizar mesas picnic para mi evento. Vi el cat\xE1logo en la web.", "cotizarHref": "/cotizar/", "data-astro-cid-r7cejkkl": true })}  ${renderComponent($$result2, "WaBubble", $$WaBubble, { "whatsapp": "5547868402", "message": "Hola, vi el cat\xE1logo de mesas picnic y quiero cotizar.", "data-astro-cid-r7cejkkl": true })}   `, "head": ($$result2) => renderTemplate`${renderComponent($$result2, "Fragment", Fragment, { "slot": "head" }, { "default": ($$result3) => renderTemplate(_a || (_a = __template([' <script type="application/ld+json">', '<\/script> <script type="application/ld+json">', "<\/script> "])), unescapeHTML(JSON.stringify({
