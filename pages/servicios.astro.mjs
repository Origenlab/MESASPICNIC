...
const $$Index = createComponent(($$result, $$props, $$slots) => {
  ...
  ], "data-astro-cid-hezqo47o": true })} ${renderComponent($$result2, "FaqSection", $$FaqSection, { "phone": "55 4786 8402", "whatsapp": "5547868402", "schedule": "Lun\u2013Dom 8:00\u201320:00", "items": [
    {
  ...
  ], "data-astro-cid-hezqo47o": true })} </section>  ${renderComponent($$result2, "CtaBarFinal", $$CtaBarFinal, { "headline": "\xBFYa sabes qu\xE9 servicio necesitas?", "subtext": "Cotiza sin compromiso. Te asesoramos seg\xFAn tu evento y presupuesto.", "phone": "55 4786 8402", "whatsapp": "5547868402", "waMessage": "Hola, quiero cotizar un servicio de mesas picnic para mi evento.", "cotizarHref": "/cotizar/", "data-astro-cid-hezqo47o": true })}   `, "head": ($$result2) => renderTemplate`${renderComponent($$result2, "Fragment", Fragment, { "slot": "head" }, { "default": ($$result3) => renderTemplate(_a || (_a = __template([' <script type="application/ld+json">', '<\/script> <script type="application/ld+json">', "<\/script> "])), unescapeHTML(JSON.stringify({
