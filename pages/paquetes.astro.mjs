...
const $$Index = createComponent(($$result, $$props, $$slots) => {
  ...
  ], "data-astro-cid-ftvjo3up": true })} ${renderComponent($$result2, "FaqSection", $$FaqSection, { "phone": "55 3068 2988", "whatsapp": "5530682988", "schedule": "Lun\u2013Dom 8:00\u201320:00", "waMessage": "Hola, quiero cotizar un paquete de mesas picnic para mi evento.", "items": [
    {
  ...
  ], "data-astro-cid-ftvjo3up": true })} </section>  ${renderComponent($$result2, "CtaBarFinal", $$CtaBarFinal, { "headline": "\xBFListo para reservar tu paquete?", "subtext": "Cotiza sin compromiso. Te confirmamos disponibilidad y precio el mismo d\xEDa.", "phone": "55 3068 2988", "whatsapp": "5530682988", "waMessage": "Hola, quiero cotizar un paquete de mesas picnic para mi evento.", "cotizarHref": "/cotizar/", "data-astro-cid-ftvjo3up": true })}  ${renderComponent($$result2, "WaBubble", $$WaBubble, { "whatsapp": "5530682988", "message": "Hola, quiero cotizar un paquete de mesas picnic.", "data-astro-cid-ftvjo3up": true })}   `, "head": ($$result2) => renderTemplate`${renderComponent($$result2, "Fragment", Fragment, { "slot": "head" }, { "default": ($$result3) => renderTemplate(_a || (_a = __template([' <script type="application/ld+json">', '<\/script> <script type="application/ld+json">', "<\/script> "])), unescapeHTML(JSON.stringify({
