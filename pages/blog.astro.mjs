...
Zonas de cobertura
</h3> <ul class="sb-coverage" data-astro-cid-5tznm7mj> <li data-astro-cid-5tznm7mj>Ciudad de México (todas las alcaldías)</li> <li data-astro-cid-5tznm7mj>Naucalpan · Huixquilucan</li> <li data-astro-cid-5tznm7mj>Atizapán · Tlalnepantla</li> <li data-astro-cid-5tznm7mj>Toluca · Metepec</li> <li data-astro-cid-5tznm7mj>Texcoco · Chalco</li> </ul> </div> </aside> </div> </div> </section> ${renderComponent($$result2, "CtaBarFinal", $$CtaBarFinal, { "headline": "\xBFListo para tu evento?", "subtext": "Cotiza sin compromiso. Te respondemos en minutos.", "phone": "55 3068 2988", "whatsapp": "5530682988", "waMessage": "Hola, quiero cotizar mesas picnic para mi evento.", "cotizarHref": "/cotizar/", "data-astro-cid-5tznm7mj": true })} ${renderComponent($$result2, "WaBubble", $$WaBubble, { "whatsapp": "5530682988", "message": "Hola, quiero cotizar mesas picnic para mi evento.", "data-astro-cid-5tznm7mj": true })}  `, "head": ($$result2) => renderTemplate`${renderComponent($$result2, "Fragment", Fragment, { "slot": "head" }, { "default": ($$result3) => renderTemplate(_a || (_a = __template([' <script type="application/ld+json">', "<\/script> "])), unescapeHTML(JSON.stringify({
