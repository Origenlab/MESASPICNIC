...
const $$CtaBarFinal = createComponent(($$result, $$props, $$slots) => {
  ...
  const waHref = `https://wa.me/52${whatsapp}?text=${encodeURIComponent(waMessage)}`;
...
}, "/sessions/nifty-hopeful-archimedes/mnt/MESASPICNIC/src/components/CtaBarFinal.astro", void 0);

export { $$CtaBarFinal as $ };
